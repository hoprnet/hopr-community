...
SELECT  COUNT(*) / COUNT(DISTINCT DATE(block_time)) AS AVG_Num_Transactions, 
...
SELECT Hourly_Weekday.AVG_Num_Transactions AS Weekday, 
       Hourly_Weekend.AVG_Num_Transactions AS Weekend, 
       Hourly_Day.AVG_Num_Transactions AS Day, 
       Hourly_Weekday.Hour
